...
//ReportInternalErrorToUser is used to send an internal server error message to the user
func ReportInternalErrorToUser(Error error, w http.ResponseWriter) {
	w.WriteHeader(500)
